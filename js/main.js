...
const projectData = [
  {
    ...
    subTitle:
      "Easy Order And Buy that Product",
    thumbnail: "../img/project-default.jpg",
    description:
      "Discover how to implement essential features like filtering, searching, adding to cart, purchasing, CRUD operations, and JWT token authentication. Simplify your development process and create a modern UI that enhances the user experience.",
    techStack: ["MERN STACK"],
    srcURL: "https://ecommernce-website.vercel.app/",
    sourceCode:"https://github.com/Kathan0611/Ecommernce-website"
  },
  {
    title: "Library Management System",
    subTitle: "Borrow and Return Your Book",
    thumbnail: "../img/thumbnails/library-thumbnail.png",
    description:
      "Nodejs with solid backend using express Framework make book are borrow from Library and return in Library and Extended day for in Library",
    techStack: ["Nodejs", "Express","MySql"],
    srcURL: "https://library-managment-jq6m.onrender.com/",
    sourceCode:"https://github.com/Kathan0611/Library_Managment"
  },
  {
    title: "Receipe Management System",
    subTitle:
      "Categorywise Reciepe Show",
    thumbnail: "../img/thumbnails/receipe-thumbnail.jpeg",
    description:
      "Receipe System through CRUD Operation, Authentication and Authorization and Cloudniary through Image Upload and learn all Things",
    techStack: ["Node.js","Express-js",'MongoDB'],
    srcURL: "https://recipe-paltforms.vercel.app/",
    sourceCode:"https://github.com/Kathan0611/recipe-paltforms"
  },
  {
    title: "Inventory Management System",
    subTitle: "Gain insights and strengthen your GitHub connections",
    thumbnail: "../img/thumbnails/inventory-thumbnail.jpeg",
    description:
      "Crud Operation,log tracking Operation,Authetication and Authroization",
    techStack: ["Nodejs", "Javascript", "MongoDB"],
    srcURL: "https://github.com/Kathan0611/Inventory-Management-System/tree/dev",
    sourceCode:"https://github.com/Kathan0611/Inventory-Management-System"
  },
  // {
  //   title: "My Battery",
  //   subTitle:
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="{sourceCode}" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
